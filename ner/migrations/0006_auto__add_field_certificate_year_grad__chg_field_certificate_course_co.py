...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Certificate.year_grad'
        db.add_column('ner_certificate', 'year_grad',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank='True'),
                      keep_default=False)


        # Changing field 'Certificate.course_content'
        db.alter_column('ner_certificate', 'course_content', self.gf('django.db.models.fields.CharField')(max_length=200, null='True'))
    def backwards(self, orm):
        # Deleting field 'Certificate.year_grad'
        db.delete_column('ner_certificate', 'year_grad')


        # Changing field 'Certificate.course_content'
        db.alter_column('ner_certificate', 'course_content', self.gf('django.db.models.fields.CharField')(default=2012, max_length=200))
    models = {
        'ner.certificate': {
            ...
            'institute': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
