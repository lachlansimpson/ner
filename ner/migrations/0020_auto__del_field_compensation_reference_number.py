...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Compensation.reference_number'
        db.delete_column('ner_compensation', 'reference_number')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Compensation.reference_number'
        raise RuntimeError("Cannot reverse this migration. 'Compensation.reference_number' and its values cannot be restored.")
    models = {
        'ner.certificate': {
