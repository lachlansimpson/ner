...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field applicants on 'Vacancy'
        db.create_table('ner_vacancy_applicants', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('vacancy', models.ForeignKey(orm['ner.vacancy'], null=False)),
            ('person', models.ForeignKey(orm['ner.person'], null=False))
        ))
        db.create_unique('ner_vacancy_applicants', ['vacancy_id', 'person_id'])

    def backwards(self, orm):
        # Removing M2M table for field applicants on 'Vacancy'
        db.delete_table('ner_vacancy_applicants')
    ...
    models = {
        ...
        'ner.vacancy': {
            ...
            'applicants': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['ner.Person']", 'null': "'True'", 'blank': "'True'"}),
