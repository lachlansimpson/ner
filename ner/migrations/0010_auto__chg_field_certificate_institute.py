...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Certificate.institute'
        db.alter_column('ner_certificate', 'institute', self.gf('django.db.models.fields.CharField')(max_length=50))
    def backwards(self, orm):

        # Changing field 'Certificate.institute'
        db.alter_column('ner_certificate', 'institute', self.gf('django.db.models.fields.CharField')(max_length=40))
    models = {
        'ner.certificate': {
        ...
        'ner.vacancy': {
            ...
            'applicants': ('django.db.models.fields.related.ManyToManyField', [], {'blank': "'True'", 'related_name': "'doodaa'", 'null': "'True'", 'symmetrical': 'False', 'to': "orm['ner.Person']"}),
