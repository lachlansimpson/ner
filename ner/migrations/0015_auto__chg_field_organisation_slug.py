...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ner_organisation', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
    def backwards(self, orm):

        # Changing field 'Organisation.slug'
        db.alter_column('ner_organisation', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=40))
    models = {
        'ner.certificate': {
