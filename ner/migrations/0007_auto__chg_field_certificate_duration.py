...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Certificate.duration'
        db.alter_column('ner_certificate', 'duration', self.gf('django.db.models.fields.CharField')(max_length=10, null='True'))
    def backwards(self, orm):

        # Changing field 'Certificate.duration'
        db.alter_column('ner_certificate', 'duration', self.gf('django.db.models.fields.CharField')(default=2012, max_length=10))
    models = {
        'ner.certificate': {
