...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organisation.slug'
        db.add_column('ner_organisation', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=2012, max_length=40),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Organisation.slug'
        db.delete_column('ner_organisation', 'slug')
