...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field certificates on 'Vacancy'
        db.create_table('ner_vacancy_certificates', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('vacancy', models.ForeignKey(orm['ner.vacancy'], null=False)),
            ('certificate', models.ForeignKey(orm['ner.certificate'], null=False))
        ))
        db.create_unique('ner_vacancy_certificates', ['vacancy_id', 'certificate_id'])

    def backwards(self, orm):
        # Removing M2M table for field certificates on 'Vacancy'
        db.delete_table('ner_vacancy_certificates')
    ...
    models = {
        ...
        'ner.vacancy': {
            ...
            'certificates': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['ner.Certificate']", 'null': "'True'", 'blank': "'True'"}),
