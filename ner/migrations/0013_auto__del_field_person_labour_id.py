...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Person.labour_id'
        db.delete_column('ner_person', 'labour_id')


    def backwards(self, orm):
        # Adding field 'Person.labour_id'
        db.add_column('ner_person', 'labour_id',
                      self.gf('django.db.models.fields.IntegerField')(default=datetime.datetime(2012, 6, 28, 0, 0)),
                      keep_default=False)
