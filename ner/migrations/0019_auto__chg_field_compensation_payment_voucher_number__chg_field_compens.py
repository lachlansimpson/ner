...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Compensation.payment_voucher_number'
        db.alter_column('ner_compensation', 'payment_voucher_number', self.gf('django.db.models.fields.CharField')(max_length=20, null='TRUE'))

        # Changing field 'Compensation.amount_paid'
        db.alter_column('ner_compensation', 'amount_paid', self.gf('django.db.models.fields.IntegerField')(null='TRUE'))

        # Changing field 'Compensation.relationship_to_injured_party'
        db.alter_column('ner_compensation', 'relationship_to_injured_party', self.gf('django.db.models.fields.CharField')(max_length=30, null='TRUE'))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Compensation.payment_voucher_number'
        raise RuntimeError("Cannot reverse this migration. 'Compensation.payment_voucher_number' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Compensation.amount_paid'
        raise RuntimeError("Cannot reverse this migration. 'Compensation.amount_paid' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Compensation.relationship_to_injured_party'
        raise RuntimeError("Cannot reverse this migration. 'Compensation.relationship_to_injured_party' and its values cannot be restored.")
    models = {
        'ner.certificate': {
